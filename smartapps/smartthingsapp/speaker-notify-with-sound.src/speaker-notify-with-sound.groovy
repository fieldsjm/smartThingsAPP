...
private loadText() {
	switch ( actionType) {
		case "Alarm":
			state.sound = [uri: "http://192.168.1.229/housepanel/media/sounds/alarm.mp3", duration: "2"]
			break;
		case "Bell 1":
		...
		case "Bell 2":
			...
			break;
		case "Chime":
			state.sound = [uri: "http://192.168.1.229/housepanel/media/sounds/chime.mp3", duration: "1"]
			break;
		case "Doorbell":
			state.sound = [uri: "http://192.168.1.229/housepanel/media/sounds/doorbell.mp3", duration: "3"]
			break;
		case "Dogs Barking":
		...
		case "There is motion":
			...
			break;
		case "Siren":
			state.sound = [uri: "http://192.168.1.229/housepanel/media/sounds/siren.mp3", duration: "10"]
			break;
